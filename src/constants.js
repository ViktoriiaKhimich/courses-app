...
export const SHOW_COURSE_BTN = 'Show course';

export const SEARCH_BTN = 'Search';

export const CREATE_COURSE_BTN = 'Create course';

export const CREATE_AUTHOR_BTN = 'Create author';

export const ADD_AUTHOR_BTN = 'Add author';
